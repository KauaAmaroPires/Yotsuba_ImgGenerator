...
module.exports = async ({ req: req, res: res }) => {
  ...
  const Canvas = canvas.createCanvas(612, 382);
  ...
  const img2 = await canvas.loadImage('./src/image/datena.png');
...
const transform = async (image) => {
  ...
  ctx.setTransform(1, -0.13, 0, 1, 0, 0);

  ctx.drawImage(img, 0, 0, 598, 310);
